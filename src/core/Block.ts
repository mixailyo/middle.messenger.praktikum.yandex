...
export default class Block {
    ...
    private _getChildrenAndProps(propsAndChildren: Props): { children: Record<string, Block | Block[]>, props: Props } {
  ...
  private _createAndCompileTemplate(propsAndStubs: Record<string, any>): HTMLElement {
